...
# Fine-tune ZipVoice base model for Arabic with pretrained warm-start,
...
train_tsv=data/raw/arabic_train.tsv
dev_tsv=data/raw/arabic_dev.tsv
...
arabic_tokens=data/tokens_${prefix}_espeak_360.txt
